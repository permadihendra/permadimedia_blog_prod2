...
<div class="card card-article mb-4">
    <a href="{{ url('article/' . $latestArticle->slug) }}"><img class="card-img-top featured-img"
    ...
    <div class="card-body">
        ...
        <a class="btn btn-outline-primary" href="{{ route('blog-article', $latestArticle->slug) }}">Read
            more
            →</a>
    </div>
</div>
